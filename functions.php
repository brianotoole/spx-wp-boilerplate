<?php
/**
 * sparxoo-dev functions and definitions
 *
...
function sparxoo_dev_setup() {
	 ...
	 * If you're building a theme based on sparxoo-dev, use a find and replace
	 * to change 'sparxoo-dev' to the name of your theme in all the template files.
	 */
...
function sparxoo_dev_scripts() {
	wp_enqueue_style( 'sparxoo-dev-style', get_stylesheet_uri() );

	wp_enqueue_script( 'sparxoo-dev-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'sparxoo-dev-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
